...
public class ScratchCardView extends AppCompatImageView {
    ...
    public interface IRevealListener {
        public void onRevealed(ScratchCardView iv);
    ...
    public ScratchCardView(Context context, AttributeSet set) {
        super(context, set);
        init();
    }
...
//        mDrawable.setTileModeXY(Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        int endGradientColor = ContextCompat.getColor(getContext(), R.color.colorPrimaryDark);

        mGradientBgPaint.setShader(new LinearGradient(0, 0, 0, getHeight(), startGradientColor, endGradientColor, Shader.TileMode.CLAMP));
                ...
                public void onPostExecute(Float percentRevealed) {
                    ...
                    if( ! isRevealed()) {
                        ...
                        if(oldValue != percentRevealed) {
                            mRevealListener.onRevealPercentChangedListener(ScratchCardView.this, percentRevealed);
                        }

                        // if now revealed.
                        if( isRevealed()) {
                            mRevealListener.onRevealed(ScratchCardView.this);
                        }
                    }
                }
