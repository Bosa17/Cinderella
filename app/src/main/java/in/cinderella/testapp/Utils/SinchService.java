...
public class SinchService extends Service {
    ...
    private static final String APP_KEY = "4d488c48-c86f-4c7b-9779-e99f64f9f169";
    private static final String APP_SECRET = "M0f04f2FVECLNh5S6NnWEg==";
    ...
    private void attemptAutoStart() {
        ...
        if (!userID.isEmpty() && messenger != null) {
            start(userID);
        }
    }
    ...
    public class SinchServiceInterface extends Binder {
        ...
        public NotificationResult relayRemotePushNotificationPayload(final Map payload) {
            if (mSinchClient == null && !firebaseHelper.getUserID().isEmpty()) {
                createClient(firebaseHelper.getUserID());
            } else if (mSinchClient == null && firebaseHelper.getUserID().isEmpty()) {
