package com.getcinderella.app.Utils.internal;
...
import com.getcinderella.app.Utils.ItemController;
import com.getcinderella.app.Utils.MaterialMode;
import com.getcinderella.app.Utils.item.BaseTabItem;
import com.getcinderella.app.Utils.item.MaterialItemView;
import com.getcinderella.app.Utils.listener.OnTabItemSelectedListener;
import com.getcinderella.app.Utils.listener.SimpleTabItemSelectedListener;
...
public class MaterialItemLayout extends ViewGroup implements ItemController {
    ...
    public void addMaterialItem(int index, Drawable defaultDrawable, Drawable selectedDrawable, String title, int selectedColor) {
        ...
        materialItemView.initialization(title, defaultDrawable, selectedDrawable, false, mItemDefaultColor, mChangeBackgroundMode ? Color.WHITE : selectedColor);
